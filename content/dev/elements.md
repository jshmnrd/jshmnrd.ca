...
<main role="main">
    <section id="text">
        ...
        <article id="text__callouts">
            <header>
                <h1>Callouts</h1>
            </header>
            <div>
                <p>This section is by me (Joshua), I added it here for reference.</p>
                <p>These callouts are based on <a href="https://mighil.com/notion-like-callouts" target="_blank">these Notion-like callouts by Mighil</a></p>
                <p class="callout">
                    Standard callout.
                </p>
                ...
                <p class="callout grey">
                    Grey callout.
                </p>
                <p class="callout black">
                    Black callout.
                </p>
                <p class="callout brown">
                    Brown callout.
                </p>
                <p class="callout orange">
                    Orange callout.
                </p>
                <p class="callout yellow">
                    Yellow callout.
                </p>
                <p class="callout blue">
                    Blue callout.
                </p>
                <p class="callout purple">
                    Purple callout.
                </p>
                <p class="callout pink">
                    Pink callout.
                </p>
                <p class="callout red">
                    Red callout.
